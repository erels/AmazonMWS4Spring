...
public class MarketplaceWebServiceOrdersSampleConfig {
    ...
    private static final String accessKey = "REQUIRED";

    /** Developer AWS secret key. */
    private static final String secretKey = "7eb8iK0/REQUIRED+MPoNJfdTW4CBm7nbKPx2/i";

    /** The client application name. */
    private static final String appName = "REQUIRED";

    /** The client application version. */
    private static final String appVersion = "0.01";
